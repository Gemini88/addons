...
def LISTBF(murl):
    ...
    match=re.compile('<a class="teaser group" href="(.+?)"><div class=".+?"><img id=".+?" class="fit_img" src="(.+?)" alt="(.+?)"><div class=".+?"><p>Calorie Burn:(.+?)</p><p>Minutes:(.+?)</p><p>Difficulty:(.+?)</p><p>Body Focus:(.+?)</p></div>').findall(link)
