...
#debrid login
settings['realdebrid-username'] = addoncompat.get_setting("realdebrid-username")
settings['realdebrid-password'] = addoncompat.get_setting("realdebrid-password")
settings['realdebrid-quality'] = addoncompat.get_setting("realdebrid-quality")
settings['realdebrid-enable'] = addoncompat.get_setting("realdebrid-enable")
