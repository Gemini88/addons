...
def IIiIiI ( ) :
 ...
 if iII1i1 < 12 :
  if xbmc . getCondVisibility ( 'system.platform.osx' ) :
   ...
   OooOooo = os . path . join ( O0oOOoooOO0O , 'xbmc.log' )
 ...
 for Oo0o0O00 , ii1 in o00 :
  if re . search ( '12.0' , Oo0o0O00 , re . IGNORECASE ) :
   Oo0o0O00 = "Frodo"
  if re . search ( '11.0' , Oo0o0O00 , re . IGNORECASE ) :
   Oo0o0O00 = "Eden"
  if re . search ( '13.0' , Oo0o0O00 , re . IGNORECASE ) :
   Oo0o0O00 = "Gotham"
  print Oo0o0O00
  print ii1
  ooo = "http://www.google-analytics.com/__utm.gif"
