...
def DownloaderClass2(url,dest):
        try:
            ...
            dialog.ok("[B][COLOR=FF67cc33]Mash Up FIX[/COLOR]", "Report the error below at [COLOR=FF67cc33]Xbmctalk.com[/COLOR]", str(e), "We will try our best to help you")    
...
try:
    ...
    if ret:
        url = 'https://github.com/mash2k3/MashUpFixes/raw/master/FIXES/metahandlers.py'
        ...
        url = 'https://github.com/mash2k3/MashUpFixes/raw/master/FIXES/metacontainers.py'
        print "#############  Downloading from "+ url+"  #####################"
        path = xbmc.translatePath(os.path.join('special://home/addons/script.module.metahandler/lib/','metahandler'))
    ...
    dialog = xbmcgui.Dialog()
    ok=dialog.ok('[B][COLOR=FF67cc33]Mash Up FIX[/COLOR][/B]','Failed To Fix Metahandler mkdirs error','Please report to [COLOR=FF67cc33]Xbmctalk.com[/COLOR].')
    pass
