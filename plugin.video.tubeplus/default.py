...
try:
    ...
    except: raise Exception ('Metahandlers Not Found')
    try:from BeautifulSoup import BeautifulSoup
    except: raise Exception ('BeautifulSoup Not Found')
    try:from sqlite3 import dbapi2 as database
    except: raise Exception ('sqlite3 Not Found')
    try:from t0mm0.common.net import Net
    except: raise Exception ('T0mm0 Common Not Found')
    try:from t0mm0.common.addon import Addon
    except: raise Exception ('T0mm0 Common Not Found')
except Exception, e:
    xbmc.log('ERROR TubePLUS: '+str(e))
